...
<!--Title-->
<h1 class="card-title h2-responsive font-bold mt-3"><strong>Problem 3</strong></h1>


<!--Text-->
<div class="d-flex justify-content-center" align="left">
    <p class="card-text my-3" >
Chef and his assistant are playing a game.the game is as follows. chef have a list of numbers. he have replaced every digit of list with its upper case English representation i.e, "ZERO", "ONE", "TWO", "THREE", "FOUR", "FIVE", "SIX", "SEVEN", "EIGHT", "NINE" for the digits 0 through 9, in order. And jumbled all those letters in some wayto produce a string A. Now assistant needs to figure out how many digits are in the list and what those digits are. The only hint assistant have is that the list consists of those digits in nondecreasing order.<br><br>

<b>INPUT:<br></b>
The first line of the input gives the number of test cases T. Each test case consists of one line with a string A of uppercase English letters.<br><br>

<b>OUTPUT:<br></b>
For each test case, output one line containing Case #x: y, where x is the test case number (starting from 1) and y is the list of digits.<br><br>

<b>CONSTRAINTS:<br></b>
1<=T<=100<br>
3<= length of A <=2000<br><br>
...
<a href="input3.php" class ="btn btn-blue waves-effect">input3.txt<i class="fa fa-download ml-1"></i></a><br><br>
<hr class="my-4 pb-2">
Upload files here
